...
const projects = [
  ...
  {
    title: 'BGP Synthetic Data Generator',
    featured: false,
    problem: '70-row BGP hijacking dataset was too small for reliable ML model training.',
    solution: 'Python CLI using CTGAN/TVAE to learn statistical patterns and generate realistic synthetic rows preserving distributions, class balance, and value ranges.',
    impact: 'Augmented dataset from 70 → 170 rows with 100% range compliance, 0 duplicates, and excellent RME/RCV quality metrics.',
    tech: ['Python', 'CTGAN', 'TVAE', 'SDV', 'pandas', 'scikit-learn'],
    github: '',
    gradient: 'from-violet-600/15 to-transparent',
  },
  {
    title: 'MovieApp — Review & Rating System',
    featured: false,
    problem: 'Needed a full-stack movie platform with real data, auth, and production deployment.',
    solution: 'Spring Boot MVC app with layered architecture, TMDB API integration, role-based security, and Docker Compose deployment on AWS EC2.',
    impact: 'Live on AWS with 60+ TMDB movies, BCrypt auth, and advanced multi-filter search — 1,400+ lines across 20 Java source files.',
    tech: ['Java', 'Spring Boot', 'MySQL', 'Docker', 'AWS EC2', 'Thymeleaf'],
    github: 'https://github.com/Panthkakadia/movie-app-review-and-rating-system-09759',
